	...
	<div style="margin-top: 200px;margin-left: 300px;">
		<fieldset>
			...
			<form class="form-horizontal" action="<%=path %>/login_manage.do" method="post">
				...
				<div class="control-group">
					<div class="controls">
						<label class="radio inline"> <input type="radio" name="limit" value="2" checked="checked"> 实验室成员</label> 
						<label class="radio inline"> <input type="radio" name="limit" value="4"> 指导老师</label>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
