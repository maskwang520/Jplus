...
<script type="text/javascript" src="<%=path%>/manage/js/ajaxfileupload.js"></script>
<script type="text/javascript" src="<%=path%>/manage/js/main_mem.js"></script>
<style type="text/css">
.modal input {
	height: 28px;
}
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-inner">
			<div class="container">
				<a class="brand"
					href="<%=path%>/manage/memManage/main_memManage.jsp">jplus实验室成员</a>
	...
	<div id="myModal13" class="modal hide fade" tabindex="-1" role="dialog"
		...
		<div class="modal-body">
			<form id="form13" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id13" id="id13" value="${user.id}"/>
				<input type="file" id="file" name="file" onchange="checkImgType(this)">
				<br />
			...
			<div class="span10" style="height: 100%">
				<div id="showdata">
					<h3 align="center" style="margin-top: 250px;">
						<font face="楷体" size="15px">JplusOnline实验室成员管理</font>
					</h3>
				</div>
			</div>
		</div>
		...
		<div class="modal-body">
			<form id="form2" method="post">
				...
				<table class="table table-bordered">
					...
					<tr>
						<td>邮箱（常用邮箱）:</td>
						<td><input type="text" id="em2" name="email" onchange="checkEmail(this.value)"></td>
					</tr>
					<tr>
						<td>qq号:</td>
		...
		<div class="modal-body">
			<form id="form3" method="post">
				...
				<table class="table table-bordered">
					...
					<tr>
						<td>认证身份：</td>
						<td>第<input type="text" name="sessions" id="ses3" onkeyup="checkRate(this.id)"/>届实验室成员
						</td>
					</tr>
					<tr>
						<td>成员简述：</td>
