package com.jplus.ucenter.bbs.api;
...
import com.jplus.ucenter.bbs.client.Client;

/**
 * @title UCenter 站点通信接口
 * @description 此类用来同步UC Server发出的操作指令，可以根据业务需要添加相应的执行代码
 * @author Chitry
 * @time 2015.07.31
 */
public class UC extends HttpServlet {
	...
	protected void doLogin(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> $get) {
	 ...
	 * @param $get
	 */
	protected void doUpdatePwd(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> $get) {
