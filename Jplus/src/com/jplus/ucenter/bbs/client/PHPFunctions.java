...
import com.jplus.ucenter.bbs.util.Base64;
/**
 * @title PHPFunctions
 * @description 构造本接口运行所需要PHP的内置函数
 * @author Chitry
 * @time 2015.07.31
 */
public abstract class PHPFunctions {
	...
	protected String base64_decode(String input){
		try {
			return new String(com.jplus.ucenter.bbs.util.Base64.decode(input.toCharArray()),"iso-8859-1");
		} catch (Exception e) {
			return e.getMessage();
		}
	}
