package com.jplus.ucenter.bbs.client;
...
/**
 * @title UC Client
 * @description 	UC Client 调用该类来实现与UC Server之间的通信。
 * 				  	该类实现与UC Server通信的所有接口函数
 * 					将常用的 UCenter 操作封装成的客户端对象，我们在项目中主要用它来与 UCenter 打交道
 * @author Chitry
 * @time 2015.07.31
 */
public class Client extends PHPFunctions{
	...
	public static String UC_API = "http://localhost:8089/discuz/upload/uc_server";
	public static String UC_CONNECT = "";
	public static String UC_KEY = "66g62eJ8v7A6a7c3D5t2Lcf1K9w1S76bUd0crbTco7bd34H9EeBbxcxa7543FdZX";
	...
	static {
	    InputStream in = Client.class.getClassLoader().getResourceAsStream("bbsconfig.properties");
